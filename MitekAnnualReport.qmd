...
specific_snapshot <- get_specific_snapshot("20260331")
...
SnapshotDate <- lubridate::ymd("20260331")
...
```{r}
#| label: tbl-surgical2
#| tbl-cap: "Summary of PRULO surgical cases by cohort - test with continuous variable display"
...
TableRepB1 <-
  ...
  gtsummary::as_flex_table(TableRepB1) |> flextable::set_table_properties(
  layout = "autofit",
  align = "center",
  opts_word = list(
    split = TRUE
